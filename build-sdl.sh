...
cflags="-Wall -W -Wno-unused-value -Wno-missing-braces -Wno-unused-function -Wno-unused-variable -Wno-unused-parameter -DHANDMADE_INTERNAL=1 -DHANDMADE_SLOW=1 -DHANDMADE_SDL=1 -DCOMPILER_LLVM -std=c++11"
ldflags="-lsdl2"

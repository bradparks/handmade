...
extern "C" GAME_UPDATE_AND_RENDER(GameUpdateAndRender) {
         ...
         ++EntityIndex)
    {
        ...
        if (Entity->Updatable) {
            ...
            HeroBitmaps.Head = BestMatchAsset(TranState->Assets, Asset_Head,
                                              &MatchVector, &WeightVector);
            HeroBitmaps.Cape = BestMatchAsset(TranState->Assets, Asset_Cape,
                                              &MatchVector, &WeightVector);
            HeroBitmaps.Torso = BestMatchAsset(TranState->Assets, Asset_Torso,
                                               &MatchVector, &WeightVector);
            switch (Entity->Type) {
